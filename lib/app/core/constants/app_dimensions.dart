abstract class AppDimensions {
  ...
  // ── Border radius ─────────────────────────────────────────
  static const double radiusSm   = 8.0;   // chips, small badges
  static const double radiusMd   = 12.0;  // input fields, small cards
  static const double radiusLg   = 16.0;  // cards, sheets
  static const double radiusXl   = 24.0;  // large hero cards
  static const double radiusFull = 999.0; // pills, avatar, FAB
  ...
  static const double bubbleMaxWidthFraction = 0.74; // 74% of screen width
  static const double bubbleSpacing = 8.0;
