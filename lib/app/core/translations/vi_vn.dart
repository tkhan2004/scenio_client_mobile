const Map<String, String> viVN = {
  ...
  'Continue roadmap': 'Tiếp tục lộ trình',
  'View full plan': 'Xem toàn bộ lộ trình',
  'Next best step': 'Bước phù hợp tiếp theo',
  'Start now': 'Bắt đầu ngay',
  'Study reminder': 'Nhắc lịch học',
  'Roadmap tổng thể': 'Lộ trình tổng thể',
  'Lộ trình học': 'Lộ trình học',
  'Roadmap, lịch luyện tập và feedback': 'Lộ trình, lịch luyện tập và feedback',
  'Đang làm mới': 'Đang làm mới',
  'Làm mới': 'Làm mới',
  'Scenio sẽ điều chỉnh lộ trình sau mỗi phiên luyện tập.':
      'Scenio sẽ điều chỉnh lộ trình sau mỗi phiên luyện tập.',
  'bước đã hoàn thành': 'bước đã hoàn thành',
  'buổi/tuần': 'buổi/tuần',
  'Bước tiếp theo': 'Bước tiếp theo',
  'Mở': 'Mở',
  'Mở bước học': 'Mở bước học',
  'Đang lưu...': 'Đang lưu...',
  'Đánh dấu xong': 'Đánh dấu xong',
  'Sau roadmap này bạn sẽ làm được gì?': 'Sau roadmap này bạn sẽ làm được gì?',
  'Cách hoàn thành roadmap': 'Cách hoàn thành roadmap',
  'bước học': 'bước học',
  'scene chính': 'scene chính',
  'Điểm gần đây >= 70': 'Điểm gần đây >= 70',
  'Scenio sẽ cập nhật bước tiếp theo sau mỗi phiên để roadmap luôn bám theo điểm mạnh/yếu mới nhất của bạn.':
      'Scenio sẽ cập nhật bước tiếp theo sau mỗi phiên để roadmap luôn bám theo điểm mạnh/yếu mới nhất của bạn.',
  'Mở khóa sau khi hoàn thành': 'Mở khóa sau khi hoàn thành',
  'Roadmap có phần thưởng rõ ràng để demo thấy được giá trị sau quá trình học.':
      'Roadmap có phần thưởng rõ ràng để demo thấy được giá trị sau quá trình học.',
  'Next roadmap suggestion': 'Gợi ý lộ trình tiếp theo',
  'Preview summary': 'Xem trước tổng kết',
  'Lịch luyện tập và feedback': 'Lịch luyện tập và feedback',
  'buổi mỗi tuần, feedback sau từng phiên':
      'buổi mỗi tuần, feedback sau từng phiên',
  'Feedback ưu tiên': 'Feedback ưu tiên',
  'sửa lỗi theo transcript và kết quả nói':
      'sửa lỗi theo transcript và kết quả nói',
  'Checkpoint tiếp theo': 'Checkpoint tiếp theo',
  'Hoàn thành phiên tiếp theo để mở đề xuất mới.':
      'Hoàn thành phiên tiếp theo để mở đề xuất mới.',
  'Lịch gợi ý': 'Lịch gợi ý',
  'Chưa có lộ trình học': 'Chưa có lộ trình học',
  'Hoàn tất onboarding để Scenio tạo roadmap phù hợp.':
      'Hoàn tất onboarding để Scenio tạo roadmap phù hợp.',
  'Tải lại': 'Tải lại',
  'Công việc': 'Công việc',
  'Du lịch': 'Du lịch',
  ...
  'Mission outcome': 'Kết quả nhiệm vụ',
  'Achieved': 'Đã đạt',
  'Partially achieved': 'Đạt một phần',
  'Needs retry': 'Cần luyện lại',
  'You stayed in the scene, completed the guided turns, and handled the conversation goal clearly enough for this level.':
      'Bạn đã bám đúng ngữ cảnh, hoàn thành số lượt hướng dẫn và xử lý mục tiêu hội thoại đủ rõ cho level hiện tại.',
  'You kept the conversation moving, but the next session should make your replies longer, cleaner, or more specific.':
      'Bạn giữ được mạch hội thoại, nhưng phiên tiếp theo nên giúp câu trả lời dài hơn, rõ hơn hoặc cụ thể hơn.',
  'The scene goal still needs another attempt. Retry a similar scene and focus on one complete answer at a time.':
      'Mục tiêu của scene vẫn cần luyện thêm. Hãy thử lại một scene tương tự và tập trung trả lời trọn vẹn từng câu.',
  'Tiến bộ nổi bật': 'Tiến bộ nổi bật',
  'Scene đã hoàn thành': 'Scene đã hoàn thành',
  'Back to Home': 'Về trang chủ',
  'Roadmap completed': 'Hoàn thành roadmap',
  'Completion badge': 'Huy hiệu hoàn thành',
  'Badge earned': 'Đã nhận huy hiệu',
  'You unlocked a roadmap completion badge and bonus XP.':
      'Bạn đã mở khóa huy hiệu hoàn thành roadmap và XP thưởng.',
  'Recommended next roadmap': 'Roadmap tiếp theo được gợi ý',
  'Start next roadmap': 'Bắt đầu roadmap tiếp theo',
};
